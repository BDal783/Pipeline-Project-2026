...
#downloading data base for betaherpsvirinae and unzipping it
subfamily = 'datasets download virus genome taxon Betaherpesvirinae --include genome'
os.system(subfamily)
os.system("unzip ncbi_dataset.zip")

#writing the problem number to report for clarity
...
#opening longest contig file to blast each one
with open("longestContig.txt", "w") as report:
    ...
    for contig_path in contig_files:
        ...
        #print(name)
        #establishing blast out file name
        ...
        #grabbing top 5 and printing to report
